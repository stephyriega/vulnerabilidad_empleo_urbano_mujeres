...
global 	root = "H:\Mi unidad\PUCP\2021-2\TESIS_1\" 
...
use "$data/enaho_1_12.dta", clear
duplicates drop conglome vivienda hogar_12 hogar_13 hogar_14 hogar_15 hogar_16, force
...
save "$data/enaho_1_`i'_`j'_12.dta", replace
...
use "$data/enaho_2_12.dta", clear
duplicates drop conglome vivienda hogar_12 hogar_13 hogar_14 hogar_15 hogar_16 codperso_12 codperso_13 codperso_14 codperso_15 codperso_16, force
...
*15 variables
keep num conglome_* vivienda_* hogar_* codperso_* ubigeo_* dominio_* p300a_* p301a_* p306_* p310_* p314a_* p203_* p204_* p205_* p206_* p207_* p208a_* p209_* p307_* p308a_* p302_* perpanel*
...
reshape long conglome_ vivienda_ hogar_ codperso_ ubigeo_ dominio_ p300a_ p301a_  p306_ p310_  p314a_ p203_ p204_ p205_ p206_ p207_ p208a_ p209_ p307_ p308a_ p302_, i(num) j(ano)


save "$data/enaho_2_`i'_`j'_12.dta", replace
...
save "$data/enaho_3_`i'_`j'_12.dta", replace
...
reshape long conglome_ vivienda_ hogar_ codperso_ ubigeo_ estrato_ p203a_ p501_ p506r4_ p510a1_ p511a_  p512b_  p512a_ p513t_ p517_ p523_ p524a1_  p530a_ p538a1_ p541a_ p5561a_ p5562a_ p5563a_ p5564a_ p5565a_ p5566a_ p5567a_ p5568a_  p5571a_  p5572a_  p5573a_  p5574a_  p5575a_  p5576a_  p5577a_  p5578a_ p5581a_ p5582a_ p5583a_ p5584a_ p5585a_ p5586a_ p5587a_ p558a1_ p558a2_ p558a3_ p558a4_ p558a5_ p558c_ p559_01_ p559_02_ p559_03_ p559_04_ p560t_01_ p560t_02_ p560t_03_ p560t_04_ p560t_05_ p560t_06_ p560t_07_ p560t_08_ p560t_09_ p560t_10_ p599_ i524a1_ i530a_ i538a1_  d529t_ d536_ d540t_ i541a_ d543_ d544t_ ocu500_ ocupinf_ emplpsec_ fac500a_, i(num) j(ano)
*p558e6_
save "$data/enaho_4_`i'_`j'_12.dta", replace
...
keep *_`i' *_`j' num facpanel_`i'`j' factor07_`i'
gen facpanel_`i'=facpanel_`i'`j'
ren facpanel_`i'`j' facpanel_`j'
...
save "$data/enaho_5_`i'_`j'_12.dta", replace
...
*49 variables
keep conglome* vivienda* hogar* codperso* t211_* p210_* num
...
reshape long keep conglome_ vivienda_ hogar_ codperso_ t211_ p210_, i(num) j(ano)

save "$data/enaho_6_`i'_`j'_12.dta", replace
...
preserve 
*empleo
use "$data\enaho_4_`i'_`j'_12.dta", clear
*educacion
merge 1:1 num ano using "$data\enaho_2_`i'_`j'_12.dta", gen (merge2)
*salud
merge 1:1 num ano using "$data\enaho_3_`i'_`j'_12.dta", gen (merge3)
*caracteristicas de las personas en la vivienda
merge 1:1 num ano using "$data\enaho_6_`i'_`j'_12.dta", gen (merge6)
*sumaria
merge m:1 conglome_ vivienda_ hogar_ ano using "$data\enaho_5_`i'_`j'_12.dta", gen(merge4)
*características de la vivienda
merge m:1 conglome_ vivienda_ hogar_ ano using "$data\enaho_1_`i'_`j'_12.dta", gen(merge5)

*ubigeo_ dominio_ estrato_
...
ren (*_) (*)
save "$data\enaho_`i'_`j'_12.dta", replace
restore
}
