...
legend(label(1 "Hombre") label(2 "Mujer") label(3 "Total")rows(1) region(lcolor(white))) xtitle("Año") ytitle("Tasa de empleo urbana (%)") xlabel(2016(1)2019 , labsize(small)) ylabel(90(1)97, labsize(small))
